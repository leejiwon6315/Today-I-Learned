...
## [ 화상 강의 토론 ]
팀원들끼리 서로 문제 푸는 방식과 생각을 공유함.<br/> 
개인적인 이야기들로 서로를 조금 알아가는 시간이었음.

<br/>
<br/>

## [ 1주차 수업 소감 ]
빅오 표기법에 대한 부분을 다시 공부하고 정리할 수 있었던 시간이었고, 반환과 대입 연산도 시간 복잡도에 포함되는 부분인 것을 명확히 알게 되었다.<br/>
또한 이론적 시간복잡도에 대한 접근이 조건이나 생각 방식에 따라 조금 달라질 수 있다고 생각했다. <br/>
ex) 배열 최솟값 접근 : 누군가(본인)는 정렬이 되어 있다는 가정하에 최선의 값이 O(1)까지 나올 수 있다고 생각함. <br/>
아직 추상 자료형과 class의 관계를 명확히 이해한 것은 아니지만, 그것은 후에 class를 다시 공부해보면 알 수 있을 것 같다.<b/>
